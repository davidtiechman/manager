    ...
    <button type="button" className="rstr-card" onClick={() => onOpen(agent.id)}>
      ...
      <div className="rstr-card-footer">
        <div className="rstr-card-specs">
          <div className="rstr-spec"><span className="rstr-spec-label">{t('card.zayadId')}</span><span className="rstr-spec-val"><FitText>{p?.zayadId ?? '—'}</FitText></span></div>
          <div className="rstr-spec"><span className="rstr-spec-label">{t('card.platformId')}</span><span className="rstr-spec-val"><FitText>{p?.platformId ?? '—'}</FitText></span></div>
          <div className="rstr-spec"><span className="rstr-spec-label">{t('card.unitCode')}</span><span className="rstr-spec-val"><FitText>{p?.unitCode ?? '—'}</FitText></span></div>
        </div>
        <div className="rstr-card-created">
          <span className="rstr-spec-label">{t('card.created')}</span>
