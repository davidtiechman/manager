...
function buildColumnDefsInternal(
  ...
  return [
    ...
    col({
      ...
      valueGetter: (p) => p.data?.details?.platformData?.unit,
      flex: 1.2,
      cellRenderer: TextCell,
      filter: 'agTextColumnFilter',
      hide: true,
    ...
    col({
      ...
      valueGetter: (p) => p.data?.details?.platformData?.unitCode,
      flex: 1,
      cellRenderer: TextCell,
      filter: 'agTextColumnFilter',
      hide: true,
    ...
    col({
      ...
      valueGetter: (p) => p.data?.details?.platformData?.zayadId,
      flex: 1.2,
      filter: 'agNumberColumnFilter',
      cellRenderer: NumericCell,
      hide: true,
    ...
    col({
      ...
      valueGetter: (p) => p.data?.details?.platformData?.platform,
      flex: 1.2,
      cellRenderer: TextCell,
      filter: 'agTextColumnFilter',
      hide: true,
    ...
    col({
      ...
      valueGetter: (p) => p.data?.details?.platformData?.platformId,
      flex: 1.2,
      filter: 'agNumberColumnFilter',
      cellRenderer: NumericCell,
      hide: true,
    ...
    col({
      ...
      valueGetter: (p) => p.data?.details?.platformData?.createdAt,
      flex: 2,
      cellRenderer: DateCell,
      filter: 'agDateColumnFilter',
      hide: true,
